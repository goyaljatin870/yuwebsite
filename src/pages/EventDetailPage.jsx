...
export default function EventDetailPage() {
  ...
  const detailBackgroundImage = getAssetUrl(baseBgPath);
  const detailBackgroundRawImage = getRawGithubUrl(baseBgPath);
  ...
  return (
    <main
      ...
      style={{ '--event-detail-bg': `url("${detailBackgroundImage}"), url("${detailBackgroundRawImage}")` }}
    >
      {/* Hero Section */}
